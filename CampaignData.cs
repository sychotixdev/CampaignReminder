    ...
    [
        ...
        new ActSettings
        {
            ...
            [
                ...
                Z("Hunting Grounds",            "Exalted Orb", true, notes: "Crowbell- 2 passives, remember Freythorn"),
                Z("Freythorn",                  "Uncut Support Gem (Level 1)", notes: "King-+30 spirit; reset on 2nd and 3rd ritual"),
                ...
                Z("Ogham Manor",                "Orb of Alchemy", true, notes:"Candlemass-+20 life"),
            ]
        },
        ...
        new ActSettings
        {
            ...
            [
                ...
                Z("Vastiri Outskirts",      "Exalted Orb", true),
                Z("Mawdun Quarry",          "Uncut Spirit Gem (Level 5)"),
                Z("Mawdun Mine",            "Uncut Support Gem (Level 2)"),
                Z("Traitor's Passage",      "Artificer's Orb"),
                Z("The Halani Gates",           "Exalted Orb", true, notes:"reset at checkpoint after first gate"),
                Z("Mastodon Badlands",      "Regal Orb, Abyss Currency"),
                Z("The Bone Pits",             "Exalted Orb", true, notes:"relic drop (dogs)"),
                Z("Keth",                  "Gemcutter's Prism", true, notes:"Kabala-+2 passives, relic drop (snakes)"),
                Z("The Lost City",             "Orb of Alchemy", true),
                Z("Buried Shrines",        "Lesser Jeweller's Orb", true),
        ...
        new ActSettings
        {
            ...
            [
                ...
                Z("Infested Barrens",           "Exalted Orb", true, notes:"Go Azak Bog for passives"),
                ...
                Z("Jiquani's Sanctum",          "Exalted Orb", true, notes:"respawn checkpoint after 2nd core, wp back"),
        ...
        new ActSettings
        {
            ...
            [
                ...
                Z("Abandoned Prison",       "Exalted Orb", true, notes:"Godess-flask recovery"),
                Z("Solitary Confinement",   "Rune"),
                Z("Kedge Bay",              "Exalted Orb", true),
